...
if "__name__" == __main__:
    ...
    dataset = dataset.map(merge_text, num_proc=16, remove_columns=dataset['train'].column_names)
    ds_dedup, duplicate_clusters = deduplicate_dataset(dataset['train'], jaccard_threshold=0.80)
    ds_dedup.save_to_disk("OpenOrca-deduped")